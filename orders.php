...
<section class="placed-orders">
   ...
   <h1 class="title">প্লেস্ট অর্ডার</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> পেমেন্টের অবস্থা : <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; } ?>;"><?php echo $fetch_orders['payment_status']; ?></span> </p>
         </div>
      <?php
       }
      }else{
